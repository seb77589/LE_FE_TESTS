...
class JestReliabilityReporter {
    ...
    onTestResult(test, testResult, _aggregatedResult) {
        ...
        testResult.testResults.forEach((result) => {
            ...
            setTimeout(() => {
                this.monitor.endTest(testFile, testName, status, retryCount, result.failureMessages[0] ? new Error(result.failureMessages[0]) : undefined);
            }, 0);
        });
    }
    /**
